...
export function Features() {
  return (
    <section className="bg-[#0a1f2e] py-20 md:py-28" data-index="2">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif-display text-white text-4xl md:text-5xl leading-[1.2] mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="feature-card bg-white/5 backdrop-blur-sm rounded-2xl p-8 border hover:transform hover:-translate-y-1 hover:bg-white/[0.07]">
                <div className="w-14 h-14 rounded-full bg-amber-500/10 flex items-center justify-center mb-6">
                  <Icon className="feature-icon w-7 h-7 text-amber-500" />
                </div>
                <h3 className="font-serif-display text-white text-2xl mb-4">
                  {feature.title}
                </h3>
